# Agent Rules for Rogic.io Workspace

## [INCIDENT_REPORTING]
- **Trigger:** Whenever a critical server error, production/stage deployment failure, database migration exception, or major system outage occurs and is resolved during developer operations.
- **Instruction:** You MUST generate a Postmortem (Incident Report) document inside the `docs/incidents/` directory.
- **Filename Format:** `YYYYMMDD_short_description.md` (e.g., `20260629_flyway_migration_failure.md`)
